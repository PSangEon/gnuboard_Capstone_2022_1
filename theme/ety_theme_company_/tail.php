...
<?php }?>
		...
		<div class="container footer">
			<div class="row">
				<div class="col-md-3 text-white text-left">
					<h2>reiley</h2><!-- image or text  -->
					<p>
					reiley <a href="<?php echo G5_IMG_URL ?>" target="_blank">reileytest</a>
					</p>
					<p class="text-center">
						<div class="sns_icon">
	...
	<div class="container-fluid bg-gray">
		<div class="col-md-12 text-white text-center">
				Copyright 2022 &copy; <a href="http://reiley.live/" target="_blank">HTTP://reiley.live/</a>
		</div>
	</div><!-- /container -->

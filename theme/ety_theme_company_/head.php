		...
		<div class="row">
			<div class="col-md-12">
				<div id="tnb-left">
					...
					<div class="sns_icon">
					<a href="https://www.instagram.com/tot_jae/" target="_blank"><i class="fab fa-instagram"></i></a>
					</div>
				</div>
				<div id="tnb">
					<ul>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  ...
  <div class="container" >
	<a href="<?php echo G5_URL ?>">	
	  <img src="<?php echo G5_THEME_URL?>/data/img/logo.png" style = "margin-left : 15px">
	</a>
